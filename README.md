...
Tópicos da live-coding:
* Desenvolvimento de testes unitários para validar uma API REST;
* Principais conceitos e vantagens do uso de testes unitários;
* Desenvolvimento de funcionalidades da API pela prática de TDD.
...
* [Link dos slides da aula.](https://drive.google.com/file/d/1KPh19mvyKirorOI-UsEYHKkmZpet3Ks6/view?usp=sharing)
